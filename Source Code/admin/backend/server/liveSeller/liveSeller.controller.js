...
exports.getSelectedProducts = async (req, res) => {
  try {
    ...
    const liveSellingHistory = await LiveSeller.findOne({ liveSellingHistoryId: req.query.liveSellingHistoryId }).select("firstName lastName businessName businessTag image selectedProducts");
